 ...
 * --------------------------------------------
 */
class ACP_Column_News_Link extends AC_Column_News_Link
implements \ACP\Editing\Editable, \ACP\Sorting\Sortable, \ACP\Export\Exportable
{

  public function editing()
  {
    return new ACP_Editing_Model_News_Link($this);
  }

  public function sorting()
  {
    return new ACP_Sorting_Model_News_Link($this);
  }

  public function export()
  {
    return new ACP_Export_Model_News_Link($this);
  }
}
 ...
 */
class ACP_Editing_Model_News_Link extends \ACP\Editing\Model
{
 ...
 */
class ACP_Sorting_Model_News_Link extends \ACP\Sorting\Model
{
 ...
 */
class ACP_Export_Model_News_Link extends \ACP\Export\Model
{
