...
class AC_Column_News_Link extends \AC\Column
{
  ...
  public function __construct()
  {
    ...
    $this->set_type('column-news-link');

    // Default column label.
    $this->set_label(__('News Link', 'ac-news-link'));
  }
  ...
  public function get_raw_value($post_id)
  {
    ...
    $value = get_post_meta($post_id, 'link_external', true) ? get_post_meta($post_id, 'link_external', true) : esc_url(get_permalink($post_id));
  ...
  public function scripts()
  {
    ...
    // wp_enqueue_script( 'ac-link_external', plugin_dir_url( __FILE__ ) . "js/column.js" );
    // wp_enqueue_style( 'ac-link_external', plugin_dir_url( __FILE__ ) . "css/column.css" );
  }
}
